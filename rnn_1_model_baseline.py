...
# SCALE VARIABLES
x_cols = cols = ['1_2_nad', '3', '4', '13', 'energy_loss', '1_2_nad_55_corg', '1_2_nad_56_fe', '1_2_nad_57_s']
y_col = '58'
...
plt.plot(np.arange(epochs), history.history['val_mean_squared_error'], label='test_mse')
plt.legend()
