...
cols.extend([str(i) for i in range(22, 51)])  # Pozostale cechy

cols.append('58')  # target - temp zuzla
...
# SCALE VARIABLES
x_cols = ['1_2_nad', '3', '4', '13', 'energy_loss', '1_2_nad_55_corg', '1_2_nad_56_fe', '1_2_nad_57_s', '58_t-1']
x_cols.extend([str(i) for i in range(22, 51)])  # Pozostale cechy
y_col = '58'
...
print(train_X.shape, valid_X.shape, test_X.shape)  # (7659, 60, 38) (852, 60, 38) (2128, 60, 38)
